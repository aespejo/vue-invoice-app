  ...
  <div class="home container">
    <div class="header flex">
      ...
      <div class="right flex">
        <div @click="toggleFilterMenu" ref="filter" class="filter flex">
    ...
    <!-- Invoices  -->
    <template v-if="filteredData.length && invoicesLoaded">
